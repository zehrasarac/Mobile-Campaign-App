    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("")){
                    Toast.makeText(AdminPanelActivity.this,"Restoran adı gerekli",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AdminPanelActivity.this,"Restoran eklendi",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
