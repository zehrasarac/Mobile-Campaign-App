...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                categorieArray = new String[]{"Pide", "Et Restoran", "Ev Yemeği"};
    ...
    public void addExistingStores(){
        String storeNames[] = {"Sampi", "Kavacık Mangal", "Maya Cafe"};
        LatLng storeCoordinates[] = {new LatLng(41.082947, 29.082765),new LatLng(41.010334, 29.210970),new LatLng(41.096057, 29.099827)};
        String storeCampaigns[] = {"Bir pide alana ikinci yarı fiyatına","Pişirilmiş etde %30 indirim","Bir porsiyon alana ikinci iki yarı fiyatına"};
        String storeCategories[][] = {{"Pide"},{"Et Restoran"},{"Ev Yemeği"}};
